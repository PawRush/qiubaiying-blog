...
export class PipelineStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    new FrontendStack(deployStage, "QiubaiUIFrontend-prod", {
      stackName: "QiubaiUIFrontend-prod",
      environment: "prod",
      buildOutputPath: "../_site",
    });
